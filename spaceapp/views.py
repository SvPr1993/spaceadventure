...
# Прочитать про линукс, про косикс
# Сделать простой проект на джанго, должен быть бэкэнд с одним эндпоинтом, туда нужно послать дату, а в ответ возвращается солнечная активность за этот день
# Написать нужно по чистой архитектуре, 3 слоя - хендлер, юзкейс и репозиторий(1- фейк репозиторий, 2-внешний сервис)
# Ответ ввиде json из 3 поле, 1 поле дата, 2 значение солнечной активности, 3 - указать это сильная, слабая и средняя
